...
IMPORTANT — drink names: Use your knowledge of known beer, wine, and spirits brands to correct obvious OCR misreadings. If an extracted name closely resembles a well-known brand (e.g. "Michelo Uta" → "Michelob Ultra", "Stella Artoi" → "Stella Artois"), use the correct spelling. Only correct names you are confident about — preserve unusual or unfamiliar names as written.
